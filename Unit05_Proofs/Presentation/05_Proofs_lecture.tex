...
\begin{example}
\begin{itemize}
	 \item If it is the last school day of the year students get their report cards.
	 \pause
	 \item This is logically equivalent to
	 \pause
	 \item If students do not get their report cards it can't be the last school day of the year.
\end{itemize}
\end{example}
\pause
